...
class ManualCoordinator:
    ...
    def __init__(self):
        self.logger = get_orchestrator_logger("manual_pipeline")
        
        # Default configurations
        self.default_course_id = get_default_course_id()
        self.default_learner_id = get_default_learner_id()
        
        self.logger.info("Initialized Manual Pipeline Coordinator")
...
manual_coordinator = ManualCoordinator()
...
def start_faculty_workflow(course_id: str, faculty_id: str, **kwargs) -> Dict[str, Any]:
    ...
    return manual_coordinator.start_course_workflow(
        course_id=course_id,
        faculty_id=faculty_id,
        **kwargs
    )
...
def faculty_approve_course(course_id: str, action: str, **kwargs) -> Dict[str, Any]:
    ...
    return manual_coordinator.faculty_approve_course_initialization(
        course_id=course_id,
        action=action,
        **kwargs
    )
...
def process_content_after_course_approval(course_id: str) -> Dict[str, Any]:
    ...
    return manual_coordinator.process_content_after_course_approval(course_id)

def faculty_approve(course_id: str, action: str, **kwargs) -> Dict[str, Any]:
    """Process faculty learning objectives approval."""
    return manual_coordinator.faculty_approve_learning_objectives(
        course_id=course_id,
        action=action,
        **kwargs
    )
...
def faculty_confirm(course_id: str, action: str, **kwargs) -> Dict[str, Any]:
    ...
    return manual_coordinator.faculty_confirm_course_structure(
        course_id=course_id,
        action=action,
        **kwargs
    )
...
def faculty_finalize(course_id: str, action: str, **kwargs) -> Dict[str, Any]:
    ...
    return manual_coordinator.faculty_finalize_knowledge_graph(
        course_id=course_id,
        action=action,
        **kwargs
    ) 